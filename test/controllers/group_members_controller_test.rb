...
class GroupMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_member" do
    assert_difference("GroupMember.count") do
      post group_members_url, params: { group_member: { group_id: @group_member.group_id, member_id: @group_member.member_id } }
    end
  ...
  test "should update group_member" do
    patch group_member_url(@group_member), params: { group_member: { group_id: @group_member.group_id, member_id: @group_member.member_id } }
