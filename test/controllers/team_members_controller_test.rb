...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference("TeamMember.count") do
      post team_members_url, params: { team_member: { member_id: @team_member.member_id, status: @team_member.status, team_id: @team_member.team_id } }
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { member_id: @team_member.member_id, status: @team_member.status, team_id: @team_member.team_id } }
